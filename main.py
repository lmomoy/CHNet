...
from model import CHNet

import matplotlib
 
matplotlib.use('AGG')

parser = argparse.ArgumentParser(description='CHNet')
...
def iterate(mode, args, loader, model, optimizer, logger, epoch):
    ...
    for i, batch_data in enumerate(loader):
        ...
        start = time.time()
        pred, pred_ob, pred_unob = model(batch_data)
...
def main():
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        iterate("train", args, train_loader, model, optimizer, logger, epoch)  # train for one epochstate
